...
namespace iyibir.TMGD.WebAPI.OData.Models.iyibir_TMGD
{
    ...
    public partial class CustomerInventory : XPCustomObject
    {
        ...
        HazardousGoodsLabel fHazardousGoodsLabel1;
        [Association(@"CustomerInventoryReferencesHazardousGoodsLabel")]
        public HazardousGoodsLabel HazardousGoodsLabel1
        {
            get { return fHazardousGoodsLabel1; }
            set { SetPropertyValue<HazardousGoodsLabel>(nameof(HazardousGoodsLabel1), ref fHazardousGoodsLabel1, value); }
        }
        HazardousGoodsLabel fHazardousGoodsLabel2;
        [Association(@"CustomerInventoryReferencesHazardousGoodsLabel1")]
        public HazardousGoodsLabel HazardousGoodsLabel2
        {
            get { return fHazardousGoodsLabel2; }
            set { SetPropertyValue<HazardousGoodsLabel>(nameof(HazardousGoodsLabel2), ref fHazardousGoodsLabel2, value); }
        }
        HazardousGoodsLabel fHazardousGoodsLabel3;
        [Association(@"CustomerInventoryReferencesHazardousGoodsLabel2")]
        public HazardousGoodsLabel HazardousGoodsLabel3
        {
            get { return fHazardousGoodsLabel3; }
            set { SetPropertyValue<HazardousGoodsLabel>(nameof(HazardousGoodsLabel3), ref fHazardousGoodsLabel3, value); }
        }
        Unitset fPackagingQuantityUnit;
        [Association(@"CustomerInventoryReferencesUnitset1")]
        public Unitset PackagingQuantityUnit
        {
            get { return fPackagingQuantityUnit; }
            set { SetPropertyValue<Unitset>(nameof(PackagingQuantityUnit), ref fPackagingQuantityUnit, value); }
        }
        Unitset fLastYearIntakeUnit;
        [Association(@"CustomerInventoryReferencesUnitset")]
        public Unitset LastYearIntakeUnit
        {
            get { return fLastYearIntakeUnit; }
            set { SetPropertyValue<Unitset>(nameof(LastYearIntakeUnit), ref fLastYearIntakeUnit, value); }
        }
    }
