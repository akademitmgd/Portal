...
namespace iyibir.TMGD.Module.BusinessObjects
{
    ...
    public class HazardousGoodsLabelEquipment : BaseObject
    {
        private HazardousGoodsLabel _hazardousGoodsLabel;
        public HazardousGoodsLabelEquipment(Session session)
            : base(session)
        {
        }
        ...
        [Association("HazardousGoodsLabel-Equipments")]
        ...
        {
            get { return GetPropertyValue<byte[]>(nameof(EquipmentImage)); }
            set { SetPropertyValue<byte[]>(nameof(EquipmentImage), value); }
        }
    }
}