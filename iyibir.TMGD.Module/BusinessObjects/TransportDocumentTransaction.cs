...
namespace iyibir.TMGD.Module.BusinessObjects
{
    ...
    public class TransportDocumentTransaction : BaseObject
    {
        ...
        public TransportDocumentTransaction(Session session)
            : base(session)
        {
        }
        ...
        [Association("TransportDocument-Transactions")]
        ...
        [RuleRequiredField("RuleRequiredField for TransportDocumentTransaction.HazardousGoods", DefaultContexts.Save)]
        [ImmediatePostData]
        ...
        [RuleRequiredField("RuleRequiredField for TransportDocumentTransaction.PackingGroup", DefaultContexts.Save)]
        ...
        [RuleValueComparison("RuleValueComparison for TransportDocumentTransaction.Quantity", DefaultContexts.Save, ValueComparisonType.GreaterThanOrEqual, 0)]
        ...
        [RuleValueComparison("RuleValueComparison for TransportDocumentTransaction.NetWeigth", DefaultContexts.Save, ValueComparisonType.GreaterThanOrEqual, 0)]
